...
router.post('/generate-quiz', async (req, res) => {
  try {
    const { text } = req.body;
    const prompt = `System: Generate a 5-question multiple choice quiz in JSON format strictly matching this schema: {"quiz": [{"question": "String", "options": ["String", "String", "String", "String"], "answer": "String"}]}. The answer must exactly match one of the options.
